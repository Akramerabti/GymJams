...
import { Package, TruckIcon, ArrowLeftRight, DollarSign, Clock, MapPin, HelpCircle, ChevronDown, ChevronUp } from 'lucide-react';
import { 
  Card, 
  CardContent, 
  CardHeader, 
...
const ReturnsSection = ({ 
  showCollapseButtons = { returns: false },
  setShowCollapseButtons,
  setActiveTab 
}) => {
  const handleCollapseToggle = (open) => {
    setShowCollapseButtons(prev => ({ ...prev, returns: !open }));
  };
