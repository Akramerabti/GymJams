...
export const FAQSection = ({
  ...
  const [faqCategoryTab, setFaqCategoryTab] = React.useState('general');
...
const FAQ = () => {
  ...
  const faqItems = {
    ...
    coaching: [
      {
        question: 'How does the coaching service work?',
        answer: 'Our coaching service connects you with certified fitness professionals who provide personalized guidance. After subscribing, youll complete a questionnaire about your goals and preferences, then be matched with a coach who will create a custom plan for you.'
      },
      {
        question: 'What qualifications do your coaches have?',
        answer: 'All our coaches are certified fitness professionals with relevant qualifications. Many hold degrees in exercise science, nutrition, or related fields, and all have practical experience working with diverse clients.'
      ...
      {
        question: 'Can I change my coach if were not a good fit?',
        answer: 'Yes, you can request a coach change if you feel your current coach isnt meeting your needs. Well work with you to find a better match.'
      },
      {
        question: 'How do I become a coach on GymJams?',
    ...
    orders: [
      {
        question: 'How do I place an order?',
        answer: 'Browse our products, add items to your cart, and proceed to checkout. Youll need to create an account or log in, then provide shipping and payment information to complete your order.'
      },
      {
        question: 'What payment methods do you accept?',
        answer: 'We accept all major credit cards, PayPal, and Apple Pay. Payment information is securely processed through our payment partners.'
      ...
      {
        question: 'Can I modify or cancel my order?',
        answer: 'You can modify or cancel your order within 24 hours of placing it, provided it hasnt shipped yet. Contact our customer service team for assistance.'
      }
    ],
    returns: [
      {
      ...
      {
        question: 'How do I initiate a return?',
        answer: 'Log in to your account, go to your Orders, select the item you wish to return, and follow the return instructions. Youll receive a return shipping label and detailed instructions.'
      },
      {
        question: 'Who pays for return shipping?',
        answer: 'For returns due to defects or errors on our part, well cover the shipping costs. For other returns, shipping fees may be the customers responsibility.'
      },
      {
        question: 'How long do refunds take to process?',
        answer: 'Once we receive your return, it takes 3-5 business days to process. Refunds typically appear in your account within 5-10 business days, depending on your payment method and financial institution.'
    ...
    membership: [
      ...
      {
        question: 'How do I redeem points?',
        answer: 'During checkout, youll see an option to apply points towards your purchase. Points can be redeemed in increments of 500, with each 500 points worth $5 off your order.'
      },
      {
        question: 'Do points expire?',
        answer: 'Points expire 12 months after they are earned if there is no account activity. Keeping your account active by making purchases or engaging with the platform will prevent points from expiring.'
  ...
  // Count total matches
  const totalMatches = Object.values(filteredFAQs).reduce(
    (sum, categoryItems) => sum + categoryItems.length, 
    0
  );
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          {searchTerm && (
            <p className="text-sm text-gray-500 mt-2">
              Found {totalMatches} {totalMatches === 1 ? 'result' : 'results'} for "{searchTerm}"
            </p>
          )}
        </div>
