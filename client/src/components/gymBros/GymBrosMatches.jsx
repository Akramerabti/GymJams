...
import { 
  X, Heart, Star, MessageCircle, ChevronLeft, ChevronRight, 
  UserPlus, MapPin, Award, Calendar, Info, Loader, RefreshCw,
  ArrowLeft, Maximize, Image as ImageIcon, Share2, Filter
} from 'lucide-react';
  ...
  return (
    <div className="relative h-full flex flex-col">
      ...
      <div className="absolute bottom-8 left-0 right-0 z-10 flex justify-center items-center space-x-4">
        ...
        <button
          onClick={() => {}}
          className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-100 shadow-lg border border-blue-200 hover:bg-blue-200 active:scale-90 transition-transform"
      ...
      <div className="absolute top-4 right-4 z-10">
        <button
          className="p-3 rounded-full bg-white shadow-md flex items-center justify-center"
          aria-label="Filter"
        >
