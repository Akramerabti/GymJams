...
// Add this function after the MapUpdater component and before the main GymBrosMap component
...
// Replace your existing renderMarkers function with this updated version:
...
const renderMarkers = () => {
  ...
  spacedFilteredUsers
    ...
    // Gym markers with enhanced membership status (unchanged from original)
    filteredGyms
      .filter(gym => {
        if (gym.location?.coordinates && Array.isArray(gym.location.coordinates)) {
