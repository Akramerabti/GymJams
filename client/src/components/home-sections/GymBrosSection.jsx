    ...
    <div className="absolute inset-0 w-full h-full overflow-hidden">
      ...
      >
        ...
        <div className="hidden lg:flex h-full">
          ...
          <div className="w-1/2 flex flex-col justify-center items-center px-8 py-6">
            {/* Header Section */}
        ...
        <div className="lg:hidden h-full flex flex-col">          {/* Header Section - Reduced height */}
          ...
          <div className="flex-none h-[12vh] min-h-[80px] max-h-[100px] flex items-center justify-center px-4 py-1">
          ...
          </div>{/* Content Section - Remaining height with proper constraints and bottom margin */}
          <div className="flex-1 min-h-0 overflow-hidden px-4 py-2 pb-8">
            <div className="h-full max-w-6xl mx-auto">
              <div className="flex flex-col gap-4 h-full">
                ...
                <div className="flex-1 min-h-0">
                  ...
                  <div className="space-y-2 overflow-y-auto max-h-[120px] mb-4">
