...
const mockCoaches = [
  {
    ...
    distance: 2.5,
    bio: "Certified personal trainer with 8+ years of experience helping clients achieve their fitness goals through personalized HIIT and strength training programs.",
    timeZone: "EST"
  },
  {
    id: 2,
    ...
    distance: 15.2,
    bio: "Former competitive bodybuilder turned coach, specializing in muscle building and athletic performance enhancement.",
    timeZone: "PST"
  },
  {
    id: 3,
    firstName: "Emma",
    lastName: "Rodriguez",
    specialties: ["Yoga", "Weight Loss", "Cardio"],
    rating: 4.7,
    profileImage: "https://images.unsplash.com/photo-1494790108755-2616b612b105?w=400&h=400&fit=crop&crop=face",
    locationDisplay: "Miami, FL",
    distance: 8.7,
    bio: "Holistic wellness coach combining traditional yoga practices with modern fitness techniques for sustainable weight loss.",
    timeZone: "EST"
  },
  {
    id: 4,
    ...
    distance: 22.1,
    bio: "CrossFit Level 3 trainer and powerlifting specialist focused on building strength and functional fitness.",
    timeZone: "CST"
  },
  {
    id: 5,
    ...
    distance: 45.3,
    bio: "Registered dietitian and fitness coach specializing in sustainable weight loss through balanced nutrition and exercise.",
    timeZone: "PST"
  },
  {
    id: 6,
    firstName: "Marcus",
    lastName: "Williams",
    specialties: ["HIIT", "Sports Performance"],
    rating: 4.8,
    profileImage: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop&crop=face",
    locationDisplay: "Atlanta, GA",
    distance: 12.8,
    bio: "Former professional athlete with expertise in high-intensity training and sports-specific conditioning.",
    timeZone: "EST"
  }
];

const getFallbackAvatarUrl = () => "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face";
    ...
    const details = [
      {
        ...
        items: [
          { icon: User, label: 'Full Name', value: `${coach.firstName} ${coach.lastName}` },
          { icon: Clock, label: 'Time Zone', value: coach.timeZone },
          { icon: MapPin, label: 'Location', value: coach.distance ? `${coach.locationDisplay} (${coach.distance} miles away)` : coach.locationDisplay }
        ]
      },
      {
        section: 'Professional Profile',
        items: [
          { icon: Star, label: 'Specialties', value: coach.specialties?.join(' • ') },
          { icon: Star, label: 'Rating', value: coach.rating ? `${coach.rating.toFixed(1)} / 5.0` : null }
        ]
      }
    ];
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 p-8 rounded-3xl shadow-2xl shadow-gray-900/20 relative overflow-hidden"
        >
          <div className="absolute inset-0 opacity-20">
            <motion.div
          ...
          <motion.div
            ...
            className="p-8 rounded-2xl shadow-2xl relative z-10 bg-white/95 backdrop-blur-sm"
          >
...
const MockCoachAssignment = () => {
  ...
  useEffect(() => {
    if (assignmentStatus === 'pending' && loading) {
      let currentIndex = 0;
      let timeoutId;
  ...
  const handleCoachSelect = (coach) => {
    ...
    // Show coach reveal animation for 5 seconds
    setTimeout(() => {
  ...
  if (loading) {
    return (
      <Card className="w-full bg-white border-gray-200 shadow-lg mt-60">
  ...
  return (
    <Card className="w-full bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 border-purple-200 shadow-xl mt-13">
      ...
      <CardContent className="p-6 bg-gradient-to-br from-blue-50/50 via-purple-50/50 to-indigo-50/50">
        {assignmentStatus === 'assigned' && selectedCoach ? (
...
export default MockCoachAssignment;